                ...
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <table data-toggle="table" data-search="true" class="table table-bordered text-center">
                            <thead>
                            <tr>
                                <th data-sortable="first_name" class="sorted" data-dir="asc">Кличка <i class="fa fa-sort"></i></th>
                                <th data-sortable="age" data-dir="asc">Возраст, лет <i class="fa fa-sort"></i></th>
                                <th data-sortable="gender" data-dir="asc">Пол <i class="fa fa-sort"></i></th>
                                <th data-sortable="qty" data-dir="asc">Отец <i class="fa fa-sort"></i></th>
                                <th data-sortable="mother" data-dir="asc">Мать <i class="fa fa-sort"></i></th>
                                <th>Действия</th>
                            </tr>
                            </thead>
                            <tbody></tbody>
